package day3.com.brms;

import org.springframework.context.support.GenericXmlApplicationContext;

import day3.com.brms.book.Book;
import day3.com.brms.book.service.BookRegisterService;
import day3.com.brms.book.service.BookSearchService;
import day3.com.brms.member.Member;
import day3.com.brms.member.service.MemberRegisterService;
import day3.com.brms.member.service.MemberSearchService;
...
public class MainClass {
	public static void main(String[] args) {
		...
		// 스프링 컨테이너 생성
		GenericXmlApplicationContext ctx = new GenericXmlApplicationContext("classpath:/day3/appCtx.xml");
